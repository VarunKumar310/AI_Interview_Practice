  ...
  return (
    <div className="min-h-screen relative text-white overflow-hidden">
      ...
      <div className="relative z-20 p-4 md:p-8">
        {error && (
          <div className="max-w-3xl mx-auto mb-4 bg-red-900/50 border border-red-400/50 rounded-lg p-4 text-red-200">
            {error}
          </div>
        )}
        ...
        <div className="max-w-3xl mx-auto mt-8 space-y-8">
          ...
          <div className="flex gap-3">
            <input
              className="flex-1 bg-gray-800/50 border border-cyan-400/50 rounded-xl px-4 py-3 placeholder-gray-400 focus:outline-none focus:border-cyan-400"
              placeholder="Type your answer here..."
              value={input}
              onChange={(e) => setInput(e.target.value)}
              onKeyPress={(e) => e.key === "Enter" && sendText()}
            />
            <button onClick={sendText} className="bg-cyan-400 hover:bg-cyan-300 text-gray-900 px-6 py-3 rounded-xl font-medium transition">
              Send
            </button>
          </div>
