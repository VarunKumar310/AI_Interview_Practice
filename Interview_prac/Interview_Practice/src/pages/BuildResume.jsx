  ...
  return (
    <div className="min-h-screen relative text-white overflow-hidden">
      ...
      <div className="relative z-20 p-6">
        <div className="max-w-4xl mx-auto bg-gray-900/80 backdrop-blur-lg rounded-2xl p-8 shadow-2xl border border-cyan-400/50">
          <h1 className="text-5xl font-bold text-center mb-10 text-cyan-400">Build Your Resume</h1>
        ...
        <button
          onClick={generatePDF}
          className="mt-12 w-full bg-cyan-400 text-gray-900 py-5 rounded-xl text-2xl font-bold hover:bg-cyan-300 transition shadow-2xl shadow-cyan-400/30"
        >
