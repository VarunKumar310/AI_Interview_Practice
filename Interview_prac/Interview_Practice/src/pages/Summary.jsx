    ...
    <div className="min-h-screen relative text-white overflow-hidden">
      ...
      <div className="relative z-20 p-8">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-5xl font-bold text-center mb-10 text-cyan-400">Interview Summary</h1>

          <div className="grid md:grid-cols-2 gap-8 mb-12">
            {/* Radar Chart */}
            <div className="bg-gray-900/80 backdrop-blur-lg rounded-2xl p-8 border border-cyan-400/50">
